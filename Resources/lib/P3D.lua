...
-- Locator Matrix Chunk
P3D.LocatorMatrixP3DChunk = P3D.P3DChunk:newChildClass("Locator Matrix")
function P3D.LocatorMatrixP3DChunk:new(Data)
	local o = P3D.LocatorMatrixP3DChunk.parentClass.new(self, Data)
	o.Matrix = P3D.MatrixIdentity()
	o.Matrix.M11, o.Matrix.M12, o.Matrix.M13, o.Matrix.M14, o.Matrix.M21, o.Matrix.M22, o.Matrix.M23, o.Matrix.M34, o.Matrix.M31, o.Matrix.M32, o.Matrix.M33, o.Matrix.M34, o.Matrix.M41, o.Matrix.M42, o.Matrix.M43, o.Matrix.M44 = unpack("<ffffffffffffffff", o.ValueStr)
	return o
end

function P3D.LocatorMatrixP3DChunk:create(Matrix)
	local Len = 12 + 64
	return P3D.LocatorMatrixP3DChunk:new{Raw = pack("<IIIffffffffffffffff", P3D.Identifiers.Locator_Matrix, Len, Len, Matrix.M11, Matrix.M12, Matrix.M13, Matrix.M14, Matrix.M21, Matrix.M22, Matrix.M23, Matrix.M34, Matrix.M31, Matrix.M32, Matrix.M33, Matrix.M34, Matrix.M41, Matrix.M42, Matrix.M43, Matrix.M44)}
end

function P3D.LocatorMatrixP3DChunk:Output()
	local chunks = concat(self.Chunks)
	local Len = 12 + 64
	return pack("<IIIffffffffffffffff", self.ChunkType, Len, Len + chunks:len(), self.Matrix.M11, self.Matrix.M12, self.Matrix.M13, self.Matrix.M14, self.Matrix.M21, self.Matrix.M22, self.Matrix.M23, self.Matrix.M34, self.Matrix.M31, self.Matrix.M32, self.Matrix.M33, self.Matrix.M34, self.Matrix.M41, self.Matrix.M42, self.Matrix.M43, self.Matrix.M44) .. chunks
end
